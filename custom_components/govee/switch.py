"""Govee switch platform for smart plugs and sockets."""
...
from .const import DEVICE_TYPE_SOCKET
...
async def async_setup_entry(
    ...
    entities: list[GoveeSwitchEntity] = []

    for device in devices.values():
        # Only create switch entities for socket/plug devices
